...
const AdminEventPage = lazy(() => import('@/pages/admin/event'));
const AdminPointPage = lazy(() => import('@/pages/admin/point'));
        ...
        },
        {
            ...
            children: [
                ...
                },
                {
                    ...
                    element: <WrapperRouteComponent element={<AdminStaffPage />} title="Admin Staffs" />,
                },
                {
                    path: PATHS.ADMIN_EVENTS,
                    element: <WrapperRouteComponent element={<AdminEventPage />} title="Admin Events" />,
                },
                {
                    path: PATHS.ADMIN_POINTS,
                    element: <WrapperRouteComponent element={<AdminPointPage />} title="Admin Points" />,
                },
                {
